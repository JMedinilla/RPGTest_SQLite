...
public class AdventurerWithClass implements Parcelable {
    private int ad_id;
    ...
    public AdventurerWithClass(int ad_id, String ad_name, String ad_race, String ad_alignment,
    ...
    private AdventurerWithClass(Parcel in) {
        ad_id = in.readInt();
    ...
    public static final Creator<AdventurerWithClass> CREATOR = new Creator<AdventurerWithClass>() {
        @Override
        public AdventurerWithClass createFromParcel(Parcel in) {
            return new AdventurerWithClass(in);
        }

        @Override
        public AdventurerWithClass[] newArray(int size) {
            return new AdventurerWithClass[size];
        }
    };
