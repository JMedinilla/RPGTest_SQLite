...
public class AdventurerForList {
    private int rad_id;
    ...
    public AdventurerForList(int rad_id, String rad_name, String rad_race, String rad_class, int rad_str, int rad_dex, int rad_int) {
        this.rad_id = rad_id;
